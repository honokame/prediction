...
model.add(Bidirectional(LSTM(l_hidden,input_shape=(301,1),return_sequences=True))) #隠れ層のユニット数、活性化関数、入力の形
model.add(SeqSelfAttention(attention_width=40,name='Attention'))
#model.add(LSTM(l_hidden, input_shape=(length, 1), return_sequences=True))
